...
func play_game_over_feedback() -> void:
	_spawn_burst(Vector2(0.0, -4.0), 28, Color(1.0, 0.52, 0.2, 1.0), 120.0, 280.0, -130.0)
...
func _on_player_jumped() -> void:
	_spawn_burst(Vector2(0.0, 13.0), 12, Color(0.28, 0.85, 1.0, 1.0), 70.0, 150.0, 75.0)
...
func _on_player_landed() -> void:
	...
	_spawn_burst(Vector2(0.0, 14.0), spark_count, Color(0.96, 0.72, 0.28, 1.0), 80.0, 230.0, -110.0)
...
func _fill_audio_buffer() -> void:
	...
	for index: int in range(available_frames):
